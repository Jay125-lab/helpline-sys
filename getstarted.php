  ...
  <body>
    <div class="header">
      ...
      <div class="navi" id="navi">
        ...
        <a href="screentest.php">Screentest</a>
        <a href="logout.php" class="split" id="split">Get Started</a> 
    ...
    <section class="vh-100">
                    ...
                    <form action="signinval.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          ...
                          <input type="text" class="form-control" placeholder="First name" aria-label="First name" name="fname" autocomplete="off" maxlength="20" required>
                        </div>
                        <div class="col">
                          <label for="lastName" class="form-label">Last Name</label>
                          <input type="text" class="form-control" placeholder="Last name" aria-label="Last name" name="lname" autocomplete="off" maxlength="20" required>
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col-12 g-6">
                            <label for="inputEmail" class="form-label">Email</label>
                            <input type="email" class="form-control" name="email" id="inputAddress" placeholder="you@example.com" autocomplete="off" maxlength="25" required>
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col">
                          <label for="Number" class="form-label">Phone Number</label>
                          <input type="number" class="form-control" placeholder="07xxxxxxxx" aria-label="Phone Number" name="phone" autocomplete="off" maxlength="10" required>
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col">
                  ...
                  <div class="modal-header">
                    ...
                    <form action="therapistsignupval.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="row mb-4">
                        <div class="col">
                          <label for="firstName" class="form-label">First name</label>
                          <input type="text" class="form-control" placeholder="First name" aria-label="First name" name="fname" autocomplete="off" maxlength="15" required>
                        </div>
                        <div class="col">
                          <label for="lastName" class="form-label">Last Name</label>
                          <input type="text" class="form-control" placeholder="Last name" aria-label="Last name" name="lname" autocomplete="off" maxlength="15" required>
                        </div>
                      </div>
                      <div class="row mb-4">
                        <div class="col-12 g-6">
                      ...
                      <div class="row mb-4">
                        ...
                        <div class="col-3">
                          ...
                          <input type="number" class="form-control" placeholder="age" aria-label="Age" name="age" autocomplete="off" maxlength="2" required>
                        </div>
                        <div class="col-4">
                      ...
                      <div class="row mb-4">
                        <div class="col">
                        <div class="mb-3">
                                      <label for="formFile" class="form-label">Upload your qualification certificates and relevant documents. Ensure that the documents have relevant names</label>
                                      <input class="form-control" type="file" id="formFile" name="document[]" accept=".doc,.docx,.pdf,.epub,.odf" multiple required>
                                      <p class="text-muted">
                                        (i.e. if the document is a CV ensure that is indicated in the document name)
                                      </p>
                                  </div>
                        </div>
                      </div>
      ...
      <div
        class="d-flex flex-column flex-md-row text-center text-md-start justify-content-between py-4 px-4 px-xl-5 ft" style="background-color: #111;
        color: #adb5bd;">
        <!-- Copyright -->
