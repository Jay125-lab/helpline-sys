...
--
-- Host: localhost
-- Generation Time: Apr 17, 2023 at 09:49 PM
...
--
-- RELATIONSHIPS FOR TABLE `administration`:
--
...
CREATE TABLE `clienttherapist` (
  ...
  `assingmentStatus` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- RELATIONSHIPS FOR TABLE `clienttherapist`:
--   `cl_ID`
--       `signupcl` -> `ID`
--   `th_ID`
--       `thinfo` -> `thID`
...
INSERT INTO `clienttherapist` (`clth_ID`, `cl_ID`, `th_ID`, `assingmentStatus`) VALUES
(1, 1, 16, 'active'),
(3, 3, 14, 'active'),
(4, 2, 14, 'active'),
(5, 4, 14, 'active');
...
--
-- RELATIONSHIPS FOR TABLE `counties`:
--
...
--
-- RELATIONSHIPS FOR TABLE `imgtbl`:
--
...
--
-- RELATIONSHIPS FOR TABLE `signupcl`:
--
...
CREATE TABLE `thdoctbl` (
  ...
  `docOrigName` varchar(30) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

--
-- RELATIONSHIPS FOR TABLE `thdoctbl`:
--   `thID`
--       `thinfo` -> `thID`
--
...
--
-- RELATIONSHIPS FOR TABLE `thinfo`:
--
...
--
-- RELATIONSHIPS FOR TABLE `thpictbl`:
--   `thID`
--       `thinfo` -> `thID`
--
...
--
ALTER TABLE `clienttherapist`
  MODIFY `clth_ID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
