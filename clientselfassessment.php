          ...
          <div class="col">
            <nav aria-label="breadcrumb" class="bg-light rounded-3 p-3 mb-4">
              <ol class="breadcrumb mb-0">
                ...
                <li class="breadcrumb-item cl"><a href="clientselfassessment.php" class="active">Self Assessment</a></li>
        ...
        <div class="row">
          ...
          <?php
                ...
                ?>   
                        ...
                        <form action="clientselfassessmentval.php" method="post">
                        <!-- q1 -->
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you used drugs or alcohol in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Very often</label>
                                    <label for="customRange3" class="form-label float-end">Never</label>
                                    <div class="range">
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you attended a support group meeting in the past week?</strong>
                                        </p>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you reached out to a sponsor or sober friend for support in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you engaged in a healthy hobby or activity in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very Often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you experienced any cravings for drugs or alcohol in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Very often</label>
                                    <label for="customRange3" class="form-label float-end">Never</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you felt overwhelmed or stressed in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Very often</label>
                                    <label for="customRange3" class="form-label float-end">Never</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you communicated effectively with loved ones or family members in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very Often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you made progress towards any personal goals in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you practiced mindfulness or meditation in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Have you sought out additional resources or support for your recovery in the past week?</strong>
                                        </p>
                                    </div>
                                    <label for="customRange3" class="form-label">Never</label>
                                    <label for="customRange3" class="form-label float-end">Very Often</label>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="mx-0 w-100">
                                    <div class="text">
                                        <p class="p-3">
                                        <strong>Is there anything else you would like to share about your week with your therapist?</strong>
                                        </p>
                                    </div>
